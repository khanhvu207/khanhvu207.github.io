var store = [{
        ...
        "excerpt":"A self-contained summary of some key results in probability theory. 0. Measure theory (coming soon) 1. Law of large numbers (Convergence in probability) We say that $X_n$ converges to $X$ in probability if for every $\\epsilon &gt; 0$, $\\lim_{n \\to \\infty} \\Pr(|X_n - X| &gt; \\epsilon) = 0$, denoted by...","categories": [],
        "tags": [],
